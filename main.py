...
# --- Page Setup ---
st.set_page_config(page_title="SK Trading Tool", page_icon="Images/Logo.png", layout="wide")
...
pages = ["Stock Overview", "Stock Examination", "Stock Forecasting"]
default_index = 0  # Now "Stock Overview" is the default
...
if page == "Stock Overview":
    ...
    st.session_state.company_name = col1.selectbox("Select Company", list(company_map.keys()))
